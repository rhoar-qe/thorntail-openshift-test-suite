...
public class DbExternalOracleIT extends AbstractDBOpenshiftTest {

    @Override
    protected void initDB() throws Exception {
        Properties externalDbProperties = DbAllocator.getInstance().allocate("oracle12c");

        byte[] dbDefaultsBytes = Files.readAllBytes(new File("target/test-classes/project-defaults-external-oracle.yml").toPath());
