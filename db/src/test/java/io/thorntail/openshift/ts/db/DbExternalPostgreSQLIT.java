...
public class DbExternalPostgreSQLIT extends AbstractDBOpenshiftTest {

    @Override
    protected void initDB() throws Exception {
        Properties externalDbProperties = DbAllocator.getInstance().allocate("postgresql96&&geo_RDU");

        byte[] dbDefaultsBytes = Files.readAllBytes(new File("target/test-classes/project-defaults-external-postgresql.yml").toPath());
