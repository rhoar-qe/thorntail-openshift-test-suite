...
public class DbPostgreSQLIT extends AbstractDBOpenshiftTest{
    ...
    public void initDB() throws Exception {
        ...
        OpenShiftUtils.deployConfigMapAndRollout(openShiftAssistant, "target/test-classes/project-defaults-postgresql.yml", APP_NAME, url);
    }
